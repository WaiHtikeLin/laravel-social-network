  ...
  <body>
    ...
    <div class="collapse navbar-collapse justify-content-around">
      <form class="d-flex" action="{{url('/search')}}" method="post">
          ...
          aria-label="Search" size="40" required name="search" value="@isset($value){{$value}}@endisset">
    ...
    data-keyboard="false" id="edit-copy-post">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" onsubmit="return checkCopyEdit(this)" data-feed-id=''>
    ...
    <div class="modal fade" tabindex="-1" aria-labelledby="editComment"
    aria-hidden="true" data-backdrop="static"
    ...
    <div class="modal fade" tabindex="-1" aria-labelledby="editReply"
    aria-hidden="true" data-backdrop="static"
    ...
    function createRequest(request,wrap)
    {
      ...
      <div class="flex-fill">
        ...
        <p class="text-right m-0">
          ...
          onclick="acceptRequest(this,'${request.name}')">Accept</button>
    ...
    function createMessage(msg,user,profile_pic,count,wrap)
    {
      ...
      async function acceptRequest(btn,name)
      {
        ...
        if(response.ok)
          document.querySelectorAll(".request_from_"+id).forEach(request=>{
            request.innerHTML=`You and ${name} are now friends.`;});
      }
